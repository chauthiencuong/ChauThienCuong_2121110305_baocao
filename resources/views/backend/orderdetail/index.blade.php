        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
          ...
          <div class="dashboard-table">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <a href="{{ route('orderdetail.create') }}" class="btn btn-success" style="margin-right: 15px;"><i class="fa-solid fa-plus"></i></a>
              <a href="{{ route('orderdetail.trash') }}" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
            </div>           
          </div>
...
@endif
      ...
      <table class="table">
        ...
        @endif            <td class="text-center">{{$ord->price}}</td>
            ...
            <td class="text-center">
              <a href="{{ route('orderdetail.edit', [$ord->id])}}" class="btn btn-primary" style="margin-right: 5px;"><i class="fa-solid fa-pen-to-square"></i></a>
              <a href="{{ route('orderdetail.delete', [$ord->id])}}" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
              <a href="{{ route('orderdetail.show', [$ord->id])}}" class="btn btn-info" style="margin-left: 5px;"><i class="fa-solid fa-eye"></i></a>
            </td>
