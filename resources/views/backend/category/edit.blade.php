            ...
            <div class="container">
                ...
                <form method="POST" action="{{route('category.update',[$category->id])}}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="meta_desc" value="{{$category->meta_desc}}" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Mô tả danh mục...">
                    </div>
                    <div class="mb-3">
