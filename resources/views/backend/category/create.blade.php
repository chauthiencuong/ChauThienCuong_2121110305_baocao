...
@endif
        ...
        <form method="POST" action="{{route('category.store')}}">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" value="{{old('name')}}" onkeyup="ChangeToSlug();" name="name" id="slug"  placeholder="Nhập tên danh mục...">
            </div>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" value="{{old('meta_desc')}}" name="meta_desc" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Mô tả danh mục...">
            </div>
            <div class="mb-3">
