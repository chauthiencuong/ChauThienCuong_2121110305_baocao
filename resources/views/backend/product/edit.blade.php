    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a href="{{ route('dashboard')}}" class="d-block">Châu Thiên Cường</a>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <form method="POST" action="{{route('product.update',[$product->id])}}" enctype="multipart/form-data">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" name="slug" id="convert_slug" value="{{$product->slug}}" placeholder="">

          </div>

          <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Mô tả sản phẩm</label>
            <input type="text" class="form-control" value="{{$product->meta_desc}}" name="meta_desc" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Mô tả sản phẩm...">
          </div>
          <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Từ khóa</label>
            <input type="text" class="form-control" value="{{$product->meta_key}}" name="meta_key" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Từ khóa sản phẩm...">
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input name="price" value="{{$product->price}}" id="price" type="text" class="form-control" placeholder="Hãy nhập số tiền (VNĐ)..." required>
          </div>
