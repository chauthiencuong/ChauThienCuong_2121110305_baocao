...
<div class="content-wrapper">
    ...
    <div class="container">
        ...
        <form method="POST" action="{{route('purchaseOrderDetails.store')}}">
            @csrf
            <div class="mb-3">
                <label for="exampleInputEmail1">Mã nhập hàng</label>
                <select name="purchaseOrders" class="custom-select" style="width: 200px;">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="{{old('price')}}" name="price" id="exampleInputEmail1" aria-describedby="emailHelp">
            </div>
