        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
          ...
          <div class="dashboard-table">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <a href="{{ route('purchaseOrders.index') }}" class="btn btn-success" style="margin-right: 15px;"><i class="fa-solid fa-left-long"></i></a>
            </div>           
          </div>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center">
                    ...
                    <a href="{{ route('purchaseOrders.restore', [$ord->id])}}" class="btn btn-primary" style="margin-right: 5px;"><i class="fa-solid fa-rotate-left"></i></a>
                    <form action="{{ route('purchaseOrders.destroy', $ord->id) }}" method="POST" style="display: inline;">
                        @method('DELETE')
                        @csrf
