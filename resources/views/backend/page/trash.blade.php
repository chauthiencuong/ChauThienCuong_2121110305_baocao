            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="text-center">Slug trang đơn</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="{{ route('page.restore', [$pag->id])}}" class="btn btn-primary" style="margin-right: 5px;"><i class="fa-solid fa-rotate-left"></i></a>
                            <form action="{{ route('page.destroy', $pag->id) }}" method="POST" style="display: inline;">
                                @method('DELETE')
                                @csrf
                                <button onclick="return confirm('Bạn có muốn xóa trang đơn này vĩnh viễn không?');" class="btn btn-danger"><i class="fa-solid fa-xmark"></i></button>
                            </form>
