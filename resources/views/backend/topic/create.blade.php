...
@endif
        ...
        <form method="POST" action="{{route('topic.store')}}">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" value="{{old('name')}}" onkeyup="ChangeToSlug();" name="name" id="slug"  placeholder="Nhập tên chủ đề bài viết...">
            </div>
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" value="{{old('meta_desc')}}" name="meta_desc" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Hãy nhập mô tả...">
            </div>
            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">Từ khóa</label>
              <input type="text" class="form-control" value="{{old('meta_key')}}" name="meta_key" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Hãy nhập từ khóa...">
            </div>
            <div class="mb-3">
