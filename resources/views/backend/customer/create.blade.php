...
@endif
        ...
        <input type="text" class="form-control" value="{{old('name')}}" onkeyup="ChangeToSlug();" name="name" id="slug" placeholder="Nhập tên khách hàng...">
      </div>
      <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="{{old('address')}}" name="address" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Bạn hãy nhập địa chỉ...">
            </div>
